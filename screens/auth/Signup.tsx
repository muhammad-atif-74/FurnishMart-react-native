    ...
    <SafeAreaView className="flex-1 justify-center items-center bg-blue-100 px-6">
      <View className="w-full max-w-xl space-y-6 ">
        ...
        <View className="space-y-4">
          <Input onChangeText={setUsername} placeholder="Enter username" type="default" value={username} />
        ...
        <Text className="text-center text-gray-400 text-sm">
          Already have an account? <Text className="text-primaryColor" onPress={() => navigation.navigate('Signin')}>Sign Up</Text>
        </Text>
      </View>
    </SafeAreaView>
  );
